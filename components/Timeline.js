...
const events = [
  {
    ...
    org: 'University of Lucknow, Lucknow, Uttar Pradesh',
    detail: 'Second Year — Deepening core knowledge in data structures, algorithms, full-stack web architecture, Python data science, and AI/ML foundations.',
    icon: GraduationCap,
  ...
  {
    year: '2024',
    title: 'Higher Secondary (XII) — Science (PCM + CS)',
    org: 'Heritage International Public School, Kasia, Kushinagar, Uttar Pradesh',
  ...
  },
  {
    ...
    title: 'Secondary (X)',
    org: 'Heritage International Public School, Kasia, Kushinagar, Uttar Pradesh',
    detail: 'Achieved 86% — Fostered foundational mathematics, science, and early programming passion.',
    icon: BookOpen,
